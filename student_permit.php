...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_layout'])) {
    $_SESSION['student_layout_settings']['school_year'] = $_POST['school_year'] ?? '2024-2025';
    ...
    $_SESSION['student_layout_settings']['name_y'] = intval($_POST['name_y'] ?? 110);
    ...
    $_SESSION['student_layout_settings']['dept_y'] = intval($_POST['dept_y'] ?? 129);
    $_SESSION['student_layout_settings']['plate_size'] = intval($_POST['plate_size'] ?? 11);
    $_SESSION['student_layout_settings']['plate_x'] = intval($_POST['plate_x'] ?? 6);
    $_SESSION['student_layout_settings']['plate_y'] = intval($_POST['plate_y'] ?? 180);
...
if (isset($_GET['delete_id'])) {
    ...
    if ($conn->query($delete_sql)) {
        ...
        foreach ($_SESSION['student_print_queue'] as $key => $item) {
            if (isset($item['id']) && $item['id'] == $delete_id) {
                unset($_SESSION['student_print_queue'][$key]);
                break;
            }
        }
...
<body>
    ...
    <div class="navbar d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="m-0 fw-bold text-white">Student Permit System</h4>
        </div>
        <div class="d-flex gap-2 align-items-center">
            <button class="btn btn-warning fw-bold" type="button" data-bs-toggle="collapse"
                data-bs-target="#layoutSettingsPanel" id="layoutToggleBtn">
            ...
            <form method="POST" id="layoutForm">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="school_year" id="in_sy"
                                    class="form-control text-center fw-bold"
                                    value="<?php echo htmlspecialchars($_SESSION['student_layout_settings']['school_year']); ?>"
                ...
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <div class="control-grid" style="grid-template-columns: 1fr 1fr;">
                            <div><span class="control-label-sm">Card Width</span><input type="number" name="card_w"
                                    id="card_w" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['card_w']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Card Height</span><input type="number" name="card_h"
                                    id="card_h" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['card_h']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="name_size"
                                    id="name_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['name_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="name_x"
                                    id="name_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['name_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="name_y"
                                    id="name_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['name_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="dept_size"
                                    id="dept_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['dept_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="dept_x"
                                    id="dept_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['dept_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="dept_y"
                                    id="dept_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['dept_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="plate_size"
                                    id="plate_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['plate_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="plate_x"
                                    id="plate_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['plate_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Top Pos</span><input type="number" name="plate_y"
                                    id="plate_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['plate_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number"
                                    name="valid_until_size" id="valid_until_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number"
                                    name="valid_until_x" id="valid_until_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Top Pos</span><input type="number" name="valid_until_y"
                                    id="valid_until_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">QR Size</span><input type="number" name="qr_size"
                                    id="qr_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['qr_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Right Pos</span><input type="number" name="qr_x"
                                    id="qr_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['qr_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Bottom Pos</span><input type="number" name="qr_y"
                                    id="qr_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['qr_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="sy_size"
                                    id="sy_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['sy_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Right Pos</span><input type="number" name="sy_x"
                                    id="sy_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['sy_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Top Pos</span><input type="number" name="sy_y" id="sy_y"
                                    class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['sy_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="count_size"
                                    id="count_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['count_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Right Pos</span><input type="number" name="count_x"
                                    id="count_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['count_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Top Pos</span><input type="number" name="count_y"
                                    id="count_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['student_layout_settings']['count_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 d-flex align-items-end">
                        <form method="POST"
                            onsubmit="return confirm('WARNING: This will completely DELETE the table and reset all data. Are you sure?');"
                            class="w-100">
    ...
    <div class="main-container">
        <div class="left-panel">
            ...
            <form method="POST" action="" id="permitForm">
                ...
                <input type="hidden" name="school_year" id="hidden_entry_sy"
                ...
                <input type="hidden" name="card_w" id="hidden_card_w"
                    value="<?php echo $_SESSION['student_layout_settings']['card_w']; ?>">
                <input type="hidden" name="card_h" id="hidden_card_h"
                    value="<?php echo $_SESSION['student_layout_settings']['card_h']; ?>">
                <input type="hidden" name="name_size" id="hidden_name_size"
                    value="<?php echo $_SESSION['student_layout_settings']['name_size']; ?>">
                <input type="hidden" name="name_x" id="hidden_name_x"
                    value="<?php echo $_SESSION['student_layout_settings']['name_x']; ?>">
                <input type="hidden" name="name_y" id="hidden_name_y"
                    value="<?php echo $_SESSION['student_layout_settings']['name_y']; ?>">
                <input type="hidden" name="dept_size" id="hidden_dept_size"
                    value="<?php echo $_SESSION['student_layout_settings']['dept_size']; ?>">
                <input type="hidden" name="dept_x" id="hidden_dept_x"
                    value="<?php echo $_SESSION['student_layout_settings']['dept_x']; ?>">
                <input type="hidden" name="dept_y" id="hidden_dept_y"
                    value="<?php echo $_SESSION['student_layout_settings']['dept_y']; ?>">
                <input type="hidden" name="plate_size" id="hidden_plate_size"
                    value="<?php echo $_SESSION['student_layout_settings']['plate_size']; ?>">
                <input type="hidden" name="plate_x" id="hidden_plate_x"
                    value="<?php echo $_SESSION['student_layout_settings']['plate_x']; ?>">
                <input type="hidden" name="plate_y" id="hidden_plate_y"
                    value="<?php echo $_SESSION['student_layout_settings']['plate_y']; ?>">
                <input type="hidden" name="valid_until_size" id="hidden_valid_until_size"
                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_size']; ?>">
                <input type="hidden" name="valid_until_x" id="hidden_valid_until_x"
                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_x']; ?>">
                <input type="hidden" name="valid_until_y" id="hidden_valid_until_y"
                    value="<?php echo $_SESSION['student_layout_settings']['valid_until_y']; ?>">
                <input type="hidden" name="qr_size" id="hidden_qr_size"
                    value="<?php echo $_SESSION['student_layout_settings']['qr_size']; ?>">
                <input type="hidden" name="qr_x" id="hidden_qr_x"
                    value="<?php echo $_SESSION['student_layout_settings']['qr_x']; ?>">
                <input type="hidden" name="qr_y" id="hidden_qr_y"
                    value="<?php echo $_SESSION['student_layout_settings']['qr_y']; ?>">
                <input type="hidden" name="count_size" id="hidden_count_size"
                    value="<?php echo $_SESSION['student_layout_settings']['count_size']; ?>">
                <input type="hidden" name="count_x" id="hidden_count_x"
                    value="<?php echo $_SESSION['student_layout_settings']['count_x']; ?>">
                <input type="hidden" name="count_y" id="hidden_count_y"
                    value="<?php echo $_SESSION['student_layout_settings']['count_y']; ?>">
                <input type="hidden" name="sy_size" id="hidden_sy_size"
                    value="<?php echo $_SESSION['student_layout_settings']['sy_size']; ?>">
                <input type="hidden" name="sy_x" id="hidden_sy_x"
                    value="<?php echo $_SESSION['student_layout_settings']['sy_x']; ?>">
                <input type="hidden" name="sy_y" id="hidden_sy_y"
                    value="<?php echo $_SESSION['student_layout_settings']['sy_y']; ?>">

                <input type="text" name="name" id="in_name" class="form-control" placeholder="Full Name" required
                    oninput="updatePreview()"
                ...
                <input type="text" name="plate" id="in_plate" class="form-control" placeholder="Plate Number" required
                    oninput="updatePreview()"
        ...
        <div class="right-panel">
            ...
            <div class="permit-card" id="preview-card">
                ...
                <div class="stu-label">
                    <span style="font-size: 14px; color: yellow;">S</span><span style="font-size: 10px;">TUDENT
                        LICENSE</span>
                </div>
                ...
                <div class="qr-area" id="qr_container">
                    ...
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php echo $editing_permit ? urlencode($editing_permit['fb_link']) : 'Empty'; ?>"
                        class="qr-img" id="out_qr">
        ...
        <div class="table-responsive">
            <table class="table table-custom table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="9" class="text-center opacity-50">No student records found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div id="print-area">
        <?php
        if (!empty($_SESSION['student_print_queue'])) {
            foreach ($_SESSION['student_print_queue'] as $item):
                ...
                <div class="permit-card" style="width: <?php echo $cw; ?>px; height: <?php echo $ch; ?>px;">
                    ...
                    <span class="text-name"
                        style="font-size: <?php echo $ns; ?>px; left: <?php echo $nx; ?>px; top: <?php echo $ny; ?>px; width: 100%; text-align: center;"><?php echo $item['name']; ?></span>
                    <span class="text-dept"
                        style="font-size: <?php echo $ds; ?>px; left: <?php echo $dx; ?>px; top: <?php echo $dy; ?>px; width: 100%; text-align: center;"><?php echo $item['dept']; ?></span>

                    <div class="plate-info"
                        style="font-size: <?php echo $ps; ?>px; top: <?php echo $py; ?>px; left: <?php echo $px; ?>px;">PLATE#:
                        <span><?php echo $item['plate']; ?></span></div>

                    <div class="valid-until-info"
                        style="font-size: <?php echo $vs; ?>px; top: <?php echo $vy; ?>px; left: <?php echo $vx; ?>px;">Valid
                        Until: <span><?php echo htmlspecialchars($item['valid_until']); ?></span></div>

                    <div class="qr-area" style="right: <?php echo $qx; ?>px; bottom: <?php echo $qy; ?>px;">
                        <div class="control-no"
                            style="font-size: <?php echo $cs; ?>px; right: <?php echo $cx; ?>px; top: <?php echo $cy; ?>px;">
                            <?php echo $item['permit_no']; ?></div>
                        <img src="<?php echo $qr_url; ?>" class="qr-img"
                            style="width: <?php echo $qs; ?>px; height: <?php echo $qs; ?>px;">
                        <span class="sy-text"
                            style="font-size: <?php echo $ss; ?>px; position:absolute; right: <?php echo $sx; ?>px; top: <?php echo $sy_pos; ?>px; width:100%; white-space:nowrap;"><?php echo $item['sy']; ?></span>
                    </div>
                </div>
            <?php endforeach;
        } ?>
    ...
    <script>
        ...
        function syncHiddenFields() {
            // Sync the hidden school year field in the entry form
            let globalSy = document.getElementById('in_sy').value;
            let hiddenEntrySy = document.getElementById('hidden_entry_sy');

            <?php if (!$editing_permit): ?>
                if (hiddenEntrySy) hiddenEntrySy.value = globalSy;
            <?php endif; ?>

            // Sync all layout hidden fields
        ...
        function validateForm() {
            ...
            const plate = document.getElementById('in_plate').value.trim();
            const validUntil = document.getElementById('in_valid_until').value.trim();

            if (!name || !dept || !plate || !validUntil) {
                alert('Please fill in all required fields: Name, Department, Plate Number, and Valid Until.');
                return false;
            }
        ...
        function updatePreview() {
            ...
            let displayDept = document.getElementById('in_dept').value.toUpperCase() || "DEPARTMENT";
            let displayPlate = document.getElementById('in_plate').value.toUpperCase() || "-------";
            let displayAy = document.getElementById('in_sy').value || "2024-2025";
            ...
            document.getElementById('out_dept').innerText = displayDept;
            document.getElementById('out_plate').innerText = displayPlate;
            ...
            // Update control number position
        ...
        function resetLayout() {
            ...
            document.getElementById('in_sy').value = "2024-2025";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Sync school year input with hidden field
            let syInput = document.getElementById('in_sy');
            if (syInput) {
                syInput.addEventListener('input', function () {
                    let hiddenEntrySy = document.getElementById('hidden_entry_sy');
                    if (hiddenEntrySy) hiddenEntrySy.value = this.value;
                });
            }
