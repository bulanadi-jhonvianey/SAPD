...
<head>
    ...
    <style>
        ...
        .table-hover tbody tr:hover {
            background-color: rgba(67, 24, 255, 0.05); /* Slight blue tint on hover */
        }
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php elseif(strpos($view,'ermit')!==false || $view=='all_permits' || $view=='EMPLOYEES' || $view=='STUDENT LICENSE' || $view=='STUDENT NON-PRO'): ?>
                                <th>Permit #</th><th>Name</th><th>Type</th>
                            <?php else: ?>
                                <th>ID</th><th>User Name</th><th>Status</th>
                            <?php endif; ?>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <?php while($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <?php elseif(strpos($view,'ermit')!==false || $view=='all_permits' || $view=='EMPLOYEES' || $view=='STUDENT LICENSE' || $view=='STUDENT NON-PRO'): ?>
                                        ...
                                        <td><span class="badge bg-primary bg-opacity-10 text-primary border border-primary"><?php echo htmlspecialchars($row['type']); ?></span></td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge bg-<?php echo $badgeClass; ?>"><?php echo ucfirst($row['status']); ?></span>
                                        </td>
                                    <?php endif; ?>
                                </tr>
                            <?php endwhile; ?>
