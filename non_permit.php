...
// Initialize Session Queue for Non-Pro
if (!isset($_SESSION['np_print_queue'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_permit'])) {
    try {
        ...
        $sy = isset($_POST['school_year']) ?
            $conn->real_escape_string($_POST['school_year']) :
            $_SESSION['np_layout_settings']['school_year'];

        if (empty($name) || empty($course) || empty($plate)) {
            throw new Exception("Please fill in Name, Course/Year, and Plate Number.");
        }
...
<head>
    ...
    <style>
        ...
        .permit-card {
            width: var(--card-w);
            height: var(--card-h);
            background-image: url('background_non_pro.png');
            ...
            <form method="POST" id="layoutForm">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="school_year" id="in_sy"
                                    ...
                                    value="<?php echo htmlspecialchars($_SESSION['np_layout_settings']['school_year']); ?>"
                ...
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <div class="control-grid" style="grid-template-columns: 1fr 1fr;">
                            <div><span class="control-label-sm">Card Width</span><input type="number" name="card_w"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['card_w']; ?>"
                            ...
                            <div><span class="control-label-sm">Card Height</span><input type="number" name="card_h"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['card_h']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="name_size"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['name_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="name_x"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['name_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="name_y"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['name_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="course_size"
                                    id="course_size" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['np_layout_settings']['course_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="course_x"
                                    id="course_x" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['np_layout_settings']['course_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="course_y"
                                    id="course_y" class="form-control form-control-sm"
                                    value="<?php echo $_SESSION['np_layout_settings']['course_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="plate_size"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['plate_size']; ?>"
                                    oninput="updatePreview()"></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="count_size"
                                    ...
                                    value="<?php echo $_SESSION['np_layout_settings']['count_size']; ?>"
                                    oninput="updatePreview()"></div>
        ...
        <div class="left-panel">
            ...
            <form method="POST" action="" id="permitForm">
                ...
                <input type="hidden" name="name_y" id="hidden_name_y"
                    value="<?php echo $_SESSION['np_layout_settings']['name_y']; ?>">
                <input type="hidden" name="course_size" id="hidden_course_size"
                    value="<?php echo $_SESSION['np_layout_settings']['course_size']; ?>">
                <input type="hidden" name="course_x" id="hidden_course_x"
                    value="<?php echo $_SESSION['np_layout_settings']['course_x']; ?>">
                <input type="hidden" name="course_y" id="hidden_course_y"
                    value="<?php echo $_SESSION['np_layout_settings']['course_y']; ?>">
                ...
                <input type="text" name="name" id="in_name" class="form-control" placeholder="Student Name" required
                    oninput="updatePreview()"
        ...
        foreach ($_SESSION['np_print_queue'] as $item):
            ...
            <div class="permit-card" style="width: <?php echo $cw; ?>px; height: <?php echo $ch; ?>px;">
                ...
                <span class="text-dept"
                    style="font-size: <?php echo $cs; ?>px; left: <?php echo $cx; ?>px; top: <?php echo $cy; ?>px; width: 100%; text-align: center;"><?php echo $item['course']; ?></span>
                ...
                <div class="qr-area" style="right: <?php echo $qx; ?>px; bottom: <?php echo $qy; ?>px;">
                    <div class="control-no"
                        style="font-size: <?php echo $cts; ?>px; right: <?php echo $ctx; ?>px; top: <?php echo $cty; ?>px;">
