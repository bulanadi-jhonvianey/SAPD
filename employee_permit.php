...
// Ensures distinct permit numbers across Student, Non-Pro, and Employee
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_permit'])) {
    ...
    // We insert into the shared table first to get the next sequence number
    $conn->query("INSERT INTO global_permit_sequence () VALUES ()");
    $global_permit_no = $conn->insert_id;

    // 2. INSERT INTO PERMITS TABLE (Using the Global Number)
    $insert_sql = "INSERT INTO permits (name, department, plate_number, fb_link, permit_number, school_year) 
                    VALUES ('$name', '$dept', '$plate', '$fb_link', $global_permit_no, '$sy')";

    if ($conn->query($insert_sql)) {
        // Add to print queue using the GLOBAL permit number
        $_SESSION['print_queue'][] = [
...
if (isset($_POST['reset_db'])) {
    ...
    // FIX: Truncate global sequence so counter resets to 1
...
// Fetch the highest ID from the GLOBAL sequence to show accurate prediction
        ...
        <div class="layout-panel mx-4">
            <form method="POST" id="layoutForm">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="school_year" id="in_sy"
                                    ...
                                    value="<?php echo htmlspecialchars($_SESSION['layout_settings']['school_year']); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid" style="grid-template-columns: 1fr 1fr;">
                            <div><span class="control-label-sm">Card Width</span><input type="number" name="card_w"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['card_w']; ?>"
                            ...
                            <div><span class="control-label-sm">Card Height</span><input type="number" name="card_h"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['card_h']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="name_size"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['name_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="name_x"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['name_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="name_y"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['name_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="dept_size"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['dept_size']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">X Position</span><input type="number" name="dept_x"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['dept_x']; ?>"
                                    oninput="updatePreview()"></div>
                            <div><span class="control-label-sm">Y Position</span><input type="number" name="dept_y"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['dept_y']; ?>"
                                    oninput="updatePreview()"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="plate_size"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['plate_size']; ?>"
                                    oninput="updatePreview()"></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="control-grid">
                            <div><span class="control-label-sm">Font Size</span><input type="number" name="count_size"
                                    ...
                                    value="<?php echo $_SESSION['layout_settings']['count_size']; ?>"
                                    oninput="updatePreview()"></div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 d-flex align-items-end">
                        <form method="POST"
                            onsubmit="return confirm('WARNING: This will delete ALL permits and reset global counter.');"
                            class="w-100">
    ...
    <div class="main-container">
        <div class="left-panel">
            ...
            <form method="POST" action="" id="permitForm">
                ...
                <input type="hidden" name="school_year" id="hidden_sy"
                    value="<?php echo $editing_permit ? htmlspecialchars($editing_permit['school_year']) : htmlspecialchars($_SESSION['layout_settings']['school_year']); ?>">
                ...
                <input type="text" name="dept" id="in_dept" class="form-control" placeholder="Department / Position"
            ...
            <div class="d-flex gap-2">
                ...
                <?php if (count($_SESSION['print_queue']) > 0): ?>
                    <form method="POST"><button type="submit" name="clear_queue" class="btn btn-danger fw-bold"><i
