...
if (!isset($_SESSION['cctv_print_queue'])) { $_SESSION['cctv_print_queue'] = []; }
...
// Parse URL Messages
if (isset($_GET['success'])) $success_msg = "Record saved successfully!";
...
<head>
    ...
    <style>
        ...
        .hcc-form {
            width: 8.5in; height: 11in; background: white; color: black; padding: 0.5in;
        ...
        .header-layout { 
            ...
            width: 100%; 
            margin-bottom: 5px; 
            margin-top: 10px; /* Added to move header lower */
        }
        ...
        .logo-left { 
            ...
            left: 5px !important; 
            top: 55px !important; /* Changed from 35px to 45px to move logo lower */
        ...
        .header-banner { 
            width: 100% !important; 
            display: block; 
            margin-left: -0.5in; /* Compensate for padding */
            margin-right: -0.5in; /* Compensate for padding */
            margin-top: 15px !important; /* Changed from -0.5in to 15px to move header lower */
            width: calc(100% + 1in) !important; /* Stretch beyond padding */
        ...
        .form-table { width: 100%; border-collapse: collapse; border: 2px solid black; margin-bottom: 15px; }
        .form-table td { border: 2px solid black; padding: 8px; vertical-align: middle; font-size: 11pt; color: black; }
        .label-cell { font-weight: bold; width: 30%; background-color: white; text-transform: uppercase; color: black; }
        
        .eval-section { margin-top: 5px; color: black; }
        .eval-box {
            border: 2px solid black; margin-top: 5px; min-height: 180px; width: 100%;
            background-image: linear-gradient(black 1px, transparent 1px);
            background-size: 100% 2em; background-position: 0 1.9em;
            padding: 0 5px; line-height: 2em; font-size: 11pt; font-family: Arial, sans-serif;
            white-space: pre-wrap; overflow-wrap: break-word; word-break: break-all;     
        }

        .footer-table { width: 100%; border-collapse: collapse; border: 2px solid black; margin-top: 20px; color: black; }
        .footer-table td { border: 2px solid black; padding: 5px 10px; width: 50%; vertical-align: top; height: 80px; }
        .footer-line { border-top: 1px solid black; width: 100%; margin: 0 auto; display: block; }
        .chief-name { font-weight: bold; text-decoration: underline; text-transform: uppercase; }
        ...
        @media print {
            ...
            #print-blank-area .header-banner {
                ...
                margin-top: 15px !important; /* Changed to match preview */
                max-width: none !important;
            }
            ...
            #print-blank-area .logo-left {
                top: 45px !important; /* Changed to match preview */
            }
...
<div class="main-container">
    ...
    <div class="left-panel">
        ...
        <form method="POST">
            <input type="text" name="requestor_name" id="in_name" class="form-control" placeholder="Requestor Name" required oninput="updatePreview()">
            <input type="text" name="level_section" id="in_lvl" class="form-control" placeholder="Level / Section" required oninput="updatePreview()">
            ...
            <input type="text" name="location" id="in_loc" class="form-control" placeholder="Location of Incident" required oninput="updatePreview()">
            <textarea name="reason" id="in_reason" class="form-control" rows="3" placeholder="Reason for Review" required oninput="updatePreview()"></textarea>
            <textarea name="evaluation" id="in_eval" class="form-control" rows="3" placeholder="Evaluation (Optional)" oninput="updatePreview()"></textarea>
    ...
    <div class="right-panel">
        ...
        <div class="hcc-form">
            ...
            <table class="form-table">
                <tr><td class="label-cell">NAME</td><td class="input-cell" id="out_name"></td></tr>
                <tr><td class="label-cell">SIGNATURE</td><td class="input-cell"></td></tr>
                <tr><td class="label-cell">LEVEL/ SECTION</td><td class="input-cell" id="out_lvl"></td></tr>
                <tr><td class="label-cell">DATE OF INCIDENT</td><td class="input-cell" id="out_date"></td></tr>
                <tr><td class="label-cell">TIME OF INCIDENT</td><td class="input-cell" id="out_time"></td></tr>
                <tr><td class="label-cell">LOCATION OF INCIDENT</td><td class="input-cell" id="out_loc"></td></tr>
                <tr><td class="label-cell">REASON FOR CCTV REVIEW</td><td class="input-cell" id="out_reason" style="height: 60px; vertical-align: top;"></td></tr>
            </table>
            ...
            <tbody>
                <?php if ($recent_requests && $recent_requests->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?delete_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger btn-delete" onclick="return confirm('Delete this record?')">
                                <i class="fa fa-trash"></i>
                            </a>
                        </td>
                    </tr>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" class="text-center opacity-50 py-4">
                            ...
                            No records found. <?php echo $search_term ? 'Try a different search.' : 'Submit a form to see records here.'; ?>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
...
<div id="print-area">
    ...
    <div class="hcc-form">
        ...
        <table class="form-table">
            <tr><td class="label-cell">NAME</td><td class="input-cell"><?php echo $p['name']; ?></td></tr>
            <tr><td class="label-cell">SIGNATURE</td><td class="input-cell"></td></tr>
            <tr><td class="label-cell">LEVEL/ SECTION</td><td class="input-cell"><?php echo $p['lvl']; ?></td></tr>
            <tr><td class="label-cell">DATE OF INCIDENT</td><td class="input-cell"><?php echo $p['date']; ?></td></tr>
            <tr><td class="label-cell">TIME OF INCIDENT</td><td class="input-cell"><?php echo $print_time; ?></td></tr>
            <tr><td class="label-cell">LOCATION OF INCIDENT</td><td class="input-cell"><?php echo $p['loc']; ?></td></tr>
            <tr><td class="label-cell">REASON FOR CCTV REVIEW</td><td class="input-cell" style="height: 60px; vertical-align: top;"><?php echo $p['reason']; ?></td></tr>
        </table>
        <div class="eval-section">
            <strong>EVALUATION:</strong>
        ...
        <table class="footer-table">
            <tr>
                <td><span class="footer-label">Assisted by:</span><span class="footer-line" style="margin-top:30px;"></span><div style="text-align:center;">Safety & Protection Officer</div></td>
                <td><span class="footer-label">CCTV Reviewed by:</span><span class="footer-line" style="margin-top:30px;"></span><div style="text-align:center;">Safety & Protection Officer</div></td>
            </tr>
        </table>
        <div class="approval-section" style="margin-top: 30px;">
            <i>Approved by:</i><br><br>
...
<div id="print-blank-area">
    <div class="hcc-form">
        ...
        <table class="form-table">
            <tr><td class="label-cell">NAME</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">SIGNATURE</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">LEVEL/ SECTION</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">DATE OF INCIDENT</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">TIME OF INCIDENT</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">LOCATION OF INCIDENT</td><td class="input-cell">&nbsp;</td></tr>
            <tr><td class="label-cell">REASON FOR CCTV REVIEW</td><td class="input-cell" style="height: 60px;">&nbsp;</td></tr>
        </table>
        <div class="eval-section">
            <strong>EVALUATION:</strong>
